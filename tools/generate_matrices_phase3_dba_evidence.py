...
def build_document() -> None:
    ...
    add_table(
        ...
        [
            ...
            ("01", "01_F3_create_rl_mr_estructura.sql", "Completado. Estructura RL_MR_* creada."),
            ("02", "02_F3_register_modulo_matrices_riesgos.sql - primer intento", "Detenido por PLS-00114 antes de registrar el módulo; incidente controlado."),
            ("02R", "02_F3_register_modulo_matrices_riesgos.sql - reintento", "Completado después de ajustar el nombre interno del procedimiento a asignar_mod_usuario."),
            ("03", "03_F3_seed_metodologia_matrices_riesgos.sql", "Completado. Metodología inicial cargada."),
