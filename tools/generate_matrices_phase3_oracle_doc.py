...
def build_document() -> None:
    ...
    add_table(
        ...
        [
            ("database/19_matrices_riesgos/01_create_rl_mr_estructura.sql", "Ejecutado", "Crea secuencias, tablas, restricciones, índices y comentarios RL_MR_*.", "Ejecutado y validado."),
            ("database/19_matrices_riesgos/02_register_modulo_matrices_riesgos.sql", "Ejecutado", "Registra /matrices-riesgos en RL_MODULOS, valida RL_USUARIO_MODULOS y asigna usuarios 1 y 2 si existen. Se corrigió compatibilidad Oracle 11g usando nombre interno corto para el procedimiento de asignación.", "Ejecutado y validado."),
            ("database/19_matrices_riesgos/03_seed_metodologia_matrices_riesgos.sql", "Ejecutado", "Carga modelo base aprobado, factores institucionales 50/25/25, variables iniciales con 100% interno por factor, cinco niveles de riesgo y controles 0/10/25/40/55.", "Ejecutado y validado."),
            ("database/19_matrices_riesgos/04_fix_encoding_textos_oracle.sql", "Post-correctivo documental", "Corrige textos y comentarios con codificación dañada cuando aplique; no altera datos funcionales, cálculos ni estructura principal del módulo.", "Ejecutado como soporte documental y validado."),
            ("database/19_matrices_riesgos/05_align_estado_en_evaluacion.sql", "Incremental de alineación", "Alinea CK_RL_MR_MAT_ESTADO con Fase 4 incorporando EN_EVALUACION; valida estados existentes antes de recrear la restricción.", "Ejecutado y validado."),
        ],
        [2450, 1350, 3800, 1760],
    )
    ...
    add_checklist(
        ...
        [
            ...
            "Ejecutar el paquete database/19_matrices_riesgos/00_APLICAR_MODULO_MATRICES_RIESGOS.sql, que controla el orden completo de los scripts activos.",
