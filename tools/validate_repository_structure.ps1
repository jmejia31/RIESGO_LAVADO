...
$requiredPaths = @(
    ...
    'backend/RL.API/Features/MatricesRiesgos/Contracts/Matrices/CalculoRiesgoResultadoDto.cs',
    'backend/RL.API/Features/MatricesRiesgos/Contracts/Metodologia/MetodologiaFormularioDtos.cs',
    'backend/RL.API/Features/MatricesRiesgos/Contracts/Reportes/ReporteMatricesDtos.cs',
