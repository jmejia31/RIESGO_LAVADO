...
async function main() {
  ...
  const checks = [
    ...
    ['Acceso usuarios paginado', 'GET', `${baseUrl}/auth/usuarios/paginado?pagina=1&tamanoPagina=10`, token],
    ['Consultar monitoreo - jurídicas', 'GET', `${baseUrl}/listas/juridicas/paginado?pagina=1&tamanoPagina=10`, token],
    ['Consultar monitoreo - naturales', 'GET', `${baseUrl}/listas/naturales/paginado?pagina=1&tamanoPagina=10`, token],
    ['Consultar monitoreo - empleados', 'GET', `${baseUrl}/listas/empleados/paginado?pagina=1&tamanoPagina=10`, token],
