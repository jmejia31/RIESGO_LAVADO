...
Medición: cuerpo HTTP completo consumido con response.text(); 1 ejecuciones warm y 0 warmups por escenario; timeout 30000 ms.

| Tipo | Cold ms | Median ms | P90 ms | P95 ms | Max ms | Total | Resultado |
|---|---:|---:|---:|---:|---:|---:|---|
| naturales | 28104.81 | 4678.82 | 4678.82 | 4678.82 | 4678.82 | 242 | FAIL |
