...
BEGIN
  ...
  IF v_cnt = 0 THEN
    ...
    VALUES (SEQ_RL_MODULOS.NEXTVAL, 'Coincidencias Patrono', 'Visualización del resumen de coincidencias de patrono agrupadas por fecha', '/coincidencias-patrono', 'users', 'Listas de Cautela', 1);
  END IF;
END;
/
