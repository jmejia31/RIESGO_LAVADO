...
-- Script: 14_register_coincidencias_empleado_module.sql
-- Objetivo: Registrar módulo Coincidencias Empleado
-- ============================================================
...
DECLARE
  ...
  v_cnt    NUMBER;
BEGIN
  SELECT MOD_ID INTO v_mod_id FROM RL_MODULOS WHERE MOD_RUTA = '/coincidencias-empleado';
