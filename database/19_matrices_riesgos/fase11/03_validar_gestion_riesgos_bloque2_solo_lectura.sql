...
BEGIN
    ...
    SELECT COUNT(*) INTO v_count
      ...
      LEFT JOIN RL_USUARIOS u ON u.USR_ID = r.RIE_USR_CREACION
    ...
    SELECT COUNT(*) INTO v_count
     ...
     WHERE r.RIE_ID IS NULL OR v.VER_ID IS NULL OR u.USR_ID IS NULL;
    ...
    SELECT COUNT(*) INTO v_count
      ...
      LEFT JOIN RL_MR_EVALUACIONES_RIESGO e ON e.EVA_ID = p.PROY_EVALUACION_ID
