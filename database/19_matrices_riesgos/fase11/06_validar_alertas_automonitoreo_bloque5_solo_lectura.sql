...
SELECT 'RL_MR_SENALES_ALERTA' AS OBJETO, COUNT(*) AS TOTAL FROM RL_MR_SENALES_ALERTA
UNION ALL SELECT 'RL_MR_AUTOMONITOREO' AS OBJETO, COUNT(*) AS TOTAL FROM RL_MR_AUTOMONITOREO
...
SELECT ALE_ESTADO, COUNT(*) AS TOTAL FROM RL_MR_SENALES_ALERTA GROUP BY ALE_ESTADO ORDER BY ALE_ESTADO ASC;
...
BEGIN
    ...
    SELECT COUNT(*) INTO v_count
      ...
      LEFT JOIN RL_MR_EVALUACIONES_RIESGO e ON e.EVA_ID = a.ALE_EVALUACION_ID
    ...
    SELECT COUNT(*) INTO v_count
      ...
      LEFT JOIN RL_MR_EVALUACIONES_RIESGO e ON e.EVA_ID = m.MON_EVALUACION_ID
      LEFT JOIN RL_USUARIOS u ON u.USR_ID = m.MON_USR_ID
