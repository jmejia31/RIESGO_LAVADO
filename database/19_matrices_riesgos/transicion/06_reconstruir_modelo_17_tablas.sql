...
DECLARE
  ...
  BEGIN
    EXECUTE IMMEDIATE 'DROP TABLE ' || DBMS_ASSERT.SIMPLE_SQL_NAME(p_name) || ' CASCADE CONSTRAINTS PURGE'; -- NOSONAR: DDL dinámico de reconstrucción; nombres proceden de listas internas y DBMS_ASSERT.
  EXCEPTION WHEN OTHERS THEN
    IF SQLCODE <> -942 THEN RAISE; END IF;
  END;
  PROCEDURE drop_sequence_if_exists(p_name VARCHAR2) IS
  BEGIN
    EXECUTE IMMEDIATE 'DROP SEQUENCE ' || DBMS_ASSERT.SIMPLE_SQL_NAME(p_name); -- NOSONAR: DDL dinámico de reconstrucción; nombres proceden de listas internas y DBMS_ASSERT.
  EXCEPTION WHEN OTHERS THEN
