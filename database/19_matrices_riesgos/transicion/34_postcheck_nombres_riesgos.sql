...
-- Compara los 59 códigos y nombres contra la fuente canónica embebida en este control.
...
BEGIN
  ...
  DBMS_OUTPUT.PUT_LINE('SOURCE_ROWS=' || items.COUNT);
  ...
  IF db_rows <> 59 OR matched_codes <> 59 OR missing_codes <> 0 OR duplicate_codes <> 0 OR diffs <> 0
