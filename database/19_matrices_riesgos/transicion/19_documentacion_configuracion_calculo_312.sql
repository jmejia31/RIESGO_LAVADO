...
PROMPT DOCUMENTACION_CONFIGURACION_CALCULO_312

COMMENT ON TABLE RL_MR_FORMULAS IS 'Catálogo maestro de fórmulas administrables utilizadas en la configuración de cálculo de las matrices de riesgos LA/FT.';
...
COMMENT ON COLUMN RL_MR_FORMULA_VERSIONES.FOV_EXPRESION IS 'Definición declarativa DSL de la fórmula versionada; se almacena como dato y no se ejecuta en Oracle.';
...
PROMPT DOCUMENTACION_CONFIGURACION_CALCULO_312_APPLIED
EXIT SUCCESS
