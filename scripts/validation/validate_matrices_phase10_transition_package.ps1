...
$planPath = Join-Path $repositoryRoot 'docs/3. Módulo Matrices de Riesgos/FASE_10_PLAN_TRANSICION_FISICA_ORACLE_MODELO_17_TABLAS_PREPARADO_NO_AUTORIZADO_2026-08-06.md'
...
$recordPath = Join-Path $repositoryRoot 'docs/3. Módulo Matrices de Riesgos/FASE_10_ACTA_EJECUCION_TRANSICION_ORACLE_MODELO_17_TABLAS_PENDIENTE_2026-08-06.md'
