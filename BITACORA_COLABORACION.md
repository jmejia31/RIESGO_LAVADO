...
- Actualización previa a publicación: la regresión concurrente de Bitácora fue corregida sin ampliar el contrato `AuditoriaDto`; se retiraron campos ficticios del modal y las pruebas/E2E quedaron en verde. Esta intervención aún no tiene commit ni Quality Gate; `FASE_5_3_REANUDABLE=FALSE`; `FASE_5_3_REANUDADA=FALSE`.
