...
- **Oracle/publicación:** `ORACLE_DML_EXECUTED_BY_CODEX=NO`; `ORACLE_DDL_EXECUTED_BY_CODEX=NO`; `MANUAL_EXECUTION_PENDING=YES`. El SHA final se confirmará tras commit y push a `origin/desarrollo`; archivos untracked ajenos fueron preservados y excluidos.
