...
- Resultado fail-closed: `APPROVED_FOR_MIGRATION=0`; `REJECTED_DOCUMENTED=59`; `SILENTLY_SKIPPED=0`; `DUPLICATE_SOURCE_CODES=0`; `UNMAPPED_REQUIRED_FIELDS=0` (la columna existe pero sus valores obligatorios no). No se inventaron códigos ni se usó la numeración como sustituto. `ORACLE_DML=0`; no se implementó endpoint ni se modificaron servicios, versiones, familias, evaluaciones o cálculos.
