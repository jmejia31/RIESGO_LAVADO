...
- Publicación y gate: `FINAL_SHA=40580039c3f648030d4ecae05fbe90ffc6223942`; `AHEAD=0`; `BEHIND=0`; `REMOTE_SYNC=PASS`; `QUALITY_GATE_RUN=35377565394`; `QUALITY_GATE_SHA=40580039c3f648030d4ecae05fbe90ffc6223942`; `QUALITY_GATE_STATUS=completed`; `QUALITY_GATE_CONCLUSION=success`.
