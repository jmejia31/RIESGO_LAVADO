...
- Estado actual: `FASE_5_3=MIGRATION_READY_WITH_REJECTIONS`; `APPROVED_FOR_MIGRATION=0`; `REJECTED_DOCUMENTED=59`; `SILENTLY_SKIPPED=0`; `DUPLICATE_SOURCE_CODES=0`; `UNMAPPED_REQUIRED_FIELDS=0`; `CODE_CHANGES_MIGRATION=0`; `ORACLE_DML=0`. No se toca FormulaEngine, familias, versiones publicadas, evaluaciones ni auditoría.
