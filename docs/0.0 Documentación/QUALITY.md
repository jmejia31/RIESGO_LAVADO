...
|---|---|---:|---:|
| Backend | Lineas | 4.62% | 4.6% |
| Backend | Ramas | 4.36% | 4.3% |
...
- Backend: caracterizar `Auth` y `Usuarios` antes de reorganizarlos; ampliar fallos de persistencia de `Configuracion` y `Auditoria`.
