...
| Frontend unitario | 13 | 82 | Arranque, rutas diferidas, guards, interceptores JWT/confirmacion, sesion local, configuracion, bitacora, contratos HTTP, coordinacion, política documental y escrituras/eliminaciones simuladas de Listas/Matrices |
...
| `npm test -- --watch=false` | 82/82 pruebas Frontend |
