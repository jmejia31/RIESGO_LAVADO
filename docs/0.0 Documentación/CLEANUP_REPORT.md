...
| Frontend unitario | 13 | 70 | Arranque, rutas diferidas, guards, interceptores JWT/confirmacion, sesion local, configuracion, bitacora, contratos HTTP, coordinacion, validaciones y escrituras simuladas de Listas/Matrices |
...
| `npm test -- --watch=false` | 70/70 pruebas Frontend |
