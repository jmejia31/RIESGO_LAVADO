...
| Frontend unitario | 13 | 91 | Arranque, rutas diferidas, guards, interceptores JWT/confirmacion, sesion local, configuración, bitácora, contratos HTTP, política documental, descargas, exportaciones y edición/escrituras simuladas de Listas/Matrices |
...
| `npm test -- --watch=false` | 91/91 pruebas Frontend |
