...
| Frontend unitario | 8 | 31 | Arranque, rutas diferidas, guards, interceptor JWT, sesion local, configuracion, bitacora y presentacion de matrices |
...
| `npm test -- --watch=false` | 31/31 pruebas Frontend |
